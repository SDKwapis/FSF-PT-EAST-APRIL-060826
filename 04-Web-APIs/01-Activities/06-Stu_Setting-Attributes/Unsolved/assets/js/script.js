const divEl = document.querySelectorAll("h4");
...
for (i = 0; i < divEl.length; i++) {
  divEl[i].setAttribute("style", "color:blue; font-size: 30px; font-weight: bold");
}

titleEl.setAttribute("style", "padding-left: 10px; margin: 0px");
